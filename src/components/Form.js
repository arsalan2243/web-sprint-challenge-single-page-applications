...
const Form = (props) => {
  ...
  const submit = (event) => {
    ...
    axios
      ...
      .catch((error) => {
        setPostError(
          "the order was unsuccessful. please try again later we are working to solve the issue"
        );
      });
  };
    ...
    <div className="container">
      ...
      <form id="pizza-form" onSubmit={submit}>
        ...
        <textarea
          ...
          name="instructions"
          id="special-text"
          placeholder="I want my pizza to have a ... "
