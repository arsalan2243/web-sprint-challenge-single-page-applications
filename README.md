...
useRouteMatch is hook. it can match the current url, and give us access to our data without any rendering. URL infomration are stored in the react router props under match.

1. How would you explain form validation to someone who has never programmed before?

form validation can tell a user what they need to complete a form and give it feedback to find any mistakes.

1. In 1-2 sentences, define end to end testing.

end to end test is to simulate a user experiance using a website and to test if the website works correctly.
